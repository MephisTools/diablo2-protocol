...
function getIdentifiedInfo (reader, item) {
  try {
    ...
    if (item.quality === Item.QualityType.set) { item.set_mods = reader.read(5) }
...
function processItemStat (statId, reader, itemProperty) {
  const stat = Item.itemStatTypeReversed[statId]
  ...
  switch (statId) {
    ...
    {
      itemProperty.minimum = reader.read(saveBits)
      itemProperty.maximum = reader.read(dataReader.itemsProperties[Item.itemStatType.maximum_fire_damage].saveBits)
      return true
    }
    ...
    {
      itemProperty.minimum = reader.read(saveBits)
      itemProperty.maximum = reader.read(dataReader.itemsProperties[Item.itemStatType.maximum_lightning_damage].saveBits)
      return true
    }
    ...
    {
      itemProperty.minimum = reader.read(saveBits)
      itemProperty.maximum = reader.read(dataReader.itemsProperties[Item.itemStatType.maximum_magical_damage].saveBits)
      return true
    }
    ...
    {
      itemProperty.minimum = reader.read(saveBits)
      itemProperty.maximum = reader.read(dataReader.itemsProperties[Item.itemStatType.maximum_cold_damage].saveBits)
      itemProperty.length = reader.read(dataReader.itemsProperties[Item.itemStatType.cold_damage_length].saveBits)
      return true
    }
    ...
    {
      itemProperty.minimum = reader.read(saveBits)
      itemProperty.maximum = reader.read(dataReader.itemsProperties[Item.itemStatType.maximum_poison_damage].saveBits)
      itemProperty.length = reader.read(dataReader.itemsProperties[Item.itemStatType.poison_damage_length].saveBits)
      return true
    }
