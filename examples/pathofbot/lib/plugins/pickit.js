...
// https://github.com/kolton/d2bot-with-kolbot/blob/master/d2bs/kolbot/libs/common/Pickit.js
/*
const fs = require('fs')
...
var Pickit = {
  ...
  init: function (notify) {
    ...
    for (i = 0; i < Config.PickitFiles.length; i++) {
  ...
  pickItems: function () {
    var status; var item; var canFit;
...
var items = Storage.Inventory.Compare(Config.Inventory)
  ...
  pickItem: function (unit, status, keptLine) {
    ...
    var i; var item; var tick; var gid; var stats;

var cancelFlags = [0x01, 0x08, 0x14, 0x0c, 0x19, 0x1a];

var itemCount = me.itemcount
